...
<html lang="en">
  <head>
    ...
    <title>Poin Penilaian Personil  | Page</title>
  </head>
  <body>
...
<div class="container col-9 mt-5" >
    <div class="row ">
    <form action="{{ route('create.penilaianpersonil') }}" method="POST" enctype="multipart/form-data">
      @csrf


<div class="form-group mb-3">
  <label for="formGroupExampleInput" class="form-label" bg-secondary><h3 >Nama Personil</h3></label>
  <input type="text" name="nama_personil" class="form-control" id="formGroupExampleInput" placeholder="Nama Personil yang dinilai">
</div>
...
<figure class="text-center">
  ...
  <figcaption class="blockquote">Berikut adalah poin penilaian untuk personil</figcaption>
</figure>
...
<div class="card border-secondary mt-4">
<div class="card-body"><h3>Kepatuhan</h3></div>
</div>
<div class="card ">
<div class="card-body col-9 ">
<div class="form-check form-check-inline col-2 mt-3">
  <input class="form-check-input" type="radio" name="kepatuhan" id="inlineRadio1" value="buruk">
  <label class="form-check-label" for="inlineRadio1">1</label>
</div>

<div class="form-check form-check-inline col-2">
  <input class="form-check-input" type="radio" name="kepatuhan" id="inlineRadio2" value="kurang baik">
  <label class="form-check-label" for="inlineRadio2">2</label>
</div>

<div class="form-check form-check-inline col-2">
  <input class="form-check-input" type="radio" name="kepatuhan" id="inlineRadio3" value="cukup" >
  <label class="form-check-label" for="inlineRadio3">3 </label>
</div>

<div class="form-check form-check-inline col-2">
  <input class="form-check-input" type="radio" name="kepatuhan" id="inlineRadio3" value="baik" >
  <label class="form-check-label" for="inlineRadio4">4 </label>
</div>

<div class="form-check form-check-inline col-2">
  <input class="form-check-input" type="radio" name="kepatuhan" id="inlineRadio3" value="sangat baik" >
  <label class="form-check-label" for="inlineRadio5">5 </label>
</div>
</div>
</div>
...
<div class="card border-secondary mt-4">
<div class="card-body"><h3>Inisiatif</h3></div>
</div>
<div class="card ">
<div class="card-body col-9 ">
<div class="form-check form-check-inline col-2 mt-3">
  <input class="form-check-input" type="radio" name="inisiatif" id="inlineRadio1" value="buruk">
  <label class="form-check-label" for="inlineRadio1">1</label>
</div>

<div class="form-check form-check-inline col-2">
  <input class="form-check-input" type="radio" name="inisiatif" id="inlineRadio2" value="kurang baik">
  <label class="form-check-label" for="inlineRadio2">2</label>
</div>

<div class="form-check form-check-inline col-2">
  <input class="form-check-input" type="radio" name="inisiatif" id="inlineRadio3" value="cukup" >
  <label class="form-check-label" for="inlineRadio3">3 </label>
</div>

<div class="form-check form-check-inline col-2">
  <input class="form-check-input" type="radio" name="inisiatif" id="inlineRadio3" value="baik" >
  <label class="form-check-label" for="inlineRadio4">4 </label>
</div>

<div class="form-check form-check-inline col-2">
  <input class="form-check-input" type="radio" name="inisiatif" id="inlineRadio3" value="sangat baik" >
  <label class="form-check-label" for="inlineRadio5">5 </label>
</div>
</div>
</div>
...
<div class="card border-secondary mt-4">
<div class="card-body"><h3>Komunikasi</h3></div>
</div>
<div class="card ">
<div class="card-body col-9 ">
<div class="form-check form-check-inline col-2 mt-3">
  <input class="form-check-input" type="radio" name="komunikasi" id="inlineRadio1" value="buruk">
  <label class="form-check-label" for="inlineRadio1">1</label>
</div>

<div class="form-check form-check-inline col-2">
  <input class="form-check-input" type="radio" name="komunikasi" id="inlineRadio2" value="kurang baik">
  <label class="form-check-label" for="inlineRadio2">2</label>
</div>

<div class="form-check form-check-inline col-2">
  <input class="form-check-input" type="radio" name="komunikasi" id="inlineRadio3" value="cukup" >
  <label class="form-check-label" for="inlineRadio3">3 </label>
</div>

<div class="form-check form-check-inline col-2">
  <input class="form-check-input" type="radio" name="komunikasi" id="inlineRadio3" value="baik" >
  <label class="form-check-label" for="inlineRadio4">4 </label>
</div>

<div class="form-check form-check-inline col-2">
  <input class="form-check-input" type="radio" name="komunikasi" id="inlineRadio3" value="sangat baik" >
  <label class="form-check-label" for="inlineRadio5">5 </label>
</div>
</div>
</div>
