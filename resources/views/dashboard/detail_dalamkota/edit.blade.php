        ...
        <form action="/dashboard/dalam_kota/{{$data->id}}" method="post">
            ...
            <div class="form-floating">
                <select name="kategori_acara" onchange="ganti_kategori()" class="form-select" id="floatingSelect"
                    ...
                    <option <?php if($data->kategori_acara=='1'){echo "selected";} ?> value="1">Dalam Kota Acara Resmi</option>
                    <option <?php if($data->kategori_acara=='2'){echo "selected";} ?> value="2">Dalam Kota Acara Tidak Resmi</option>
